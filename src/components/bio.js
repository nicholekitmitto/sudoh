    ...
    render () {
        return (
            <div className="bio">
                ...
                <p>If you want to get in touch with me, buy me a coffee, talk about a potential job opportuntity, <a href="mailto:nicholedwight@gmail.com" className="colorful">give me a shout</a>! I'm now availble for any and all entry-level cybersecurity roles, if you or your company are looking to fill one of these roles with someone who is creative and <Sparkles>willing to learn</Sparkles>, please reach out to me! I'd particularly like to work for a kind company on a supportive team that helps encourage growth in each other by sharing knowledge.</p>
